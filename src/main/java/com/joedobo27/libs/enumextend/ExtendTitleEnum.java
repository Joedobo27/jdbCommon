package com.joedobo27.libs.enumextend;
...
class ExtendTitleEnum {
     ...
     */
    public static void builder(String className) throws BadBytecode, NotFoundException {
    ...
    public static ExtendTitleEnum getSingletonInstance() {
     ...
     */
    public synchronized void addExtendEntry(String fieldName, int titleId, String maleName, String femaleName, int skillId, String titleTypes) {
        if (singletonInstance == null) {
            throw new EnumExtenderException("ExtendTitleEnum instance is null, build it before addExtendEntry");
        }
    ...
    class EnumFields {
        ...
        /**
         * @param fieldName the name for the enum entry.
         * @param titleId an ID for the Titles.Titles in the enum.
         * @param maleName in-game title name for male toons.
         * @param femaleName in-game title name for femaleName toons.
         * @param skillId A id number for the skill associated with the title, see {@link SkillList}
         * @param titleTypes A string representation of entries in {@link com.wurmonline.server.players.Titles.TitleType}. In
         ...
         **/
        EnumFields(@NotNull String fieldName, int titleId, @NotNull String maleName, @NotNull String femaleName,
                   int skillId, @NotNull String titleTypes){
    ...
    private synchronized void createFieldsInEnum() throws CannotCompileException, NotFoundException {
        if (toExtendEntries.size() == 0){
            throw new EnumExtenderException("Can not extend an enum without values in toExtendEntries arrayList.");
        }
